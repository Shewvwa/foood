...
function calc() {
    ...
    function getStaticInformaytion(seletor, activeClass) {
    ...
    getStaticInformaytion('#gender div', 'calculating__choose-item_active');
    getStaticInformaytion('.calculating__choose_big div', 'calculating__choose-item_active');
    ...
    function getDinamicInformation(selector) {
        ...
        input.addEventListener('input', () => {
            ...
            if(input.value.match(/\D/g)) {
                input.style.border = '1px solid #ff000094';
                input.style.boxShadow = '0 4px 15px rgb(255 0 0 / 33%)';
            } else {
...
function modal(triggerSelector, modalSelector,modalTimerId) {
    ...
    modalTrigger.forEach(btn2 => {
        btn2.addEventListener('click', () => openModal(modalSelector, modalTimerId))
    });    
